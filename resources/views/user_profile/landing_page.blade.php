							...
							<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
								<form action="" method="">
									...
									<div class="form-group">
										<input type="text" class="form-control" onkeyup="check()" id="name" required="" name="name"   placeholder="Your Name" />
									</div>
									<div class="form-group">
										<input type="email" class="form-control" onkeyup="check()" id="email" required="" name="email"   placeholder="Your Email" />
									</div>
									<div class="form-group">
										<textarea name="message" id="message" onkeyup="check()"  class="form-control" required="" style="min-height: 150px;" placeholder="Message"></textarea>
									</div>
									<div class="form-group">
